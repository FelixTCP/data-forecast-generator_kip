...
- docs/pipeline-framework/18-executive-summary.md
...
Core rules:
- One Python file per technical step (`step_00_pre_exploration.py` … `step_17_audit.py`) plus `orchestrator.py`; Step 18 is an agentic executive summary step.
...
- Do not create planning markdown files. Only create the required executive summary Markdown when running Step 18.
